...
public class CoordinateSystem2i implements Serializable {
     ...
     * @return - новая СК
     */
    public CoordinateSystem2i scale(int s, Vector2i center) {
        ...
        Vector2i newSize = Vector2i.mul(getSize(), s);

        // получаем коэффициенты масштабирования
        Vector2i k = new Vector2i(
        ...
        return new CoordinateSystem2i(newXMin, newXMax, newYMin, newYMax);
    }
     ...
     * @return - новая СК
     */
    public CoordinateSystem2i translate(Vector2i offset) {
        // рассчитываем новые границы
