...
import static center.buran.jmath.vector.Vector3d.VECTOR_3D_OPACITY;
...
public class CoordinateSystem3d implements Serializable {
     ...
     */
    public Vector3d getRelativePos(Vector3d pos) {
        return Vector3d.subtract(pos, min);
    }
     ...
     * @return - новая СК
     */
    public CoordinateSystem3d scale(double s, Vector3d center) {
        ...
        Vector3d newSize = Vector3d.mul(getSize(), s);
        ...
        return new CoordinateSystem3d(newXMin, newXMax, newYMin, newYMax, newZMin, newZMax);
    }
     ...
     * @return - новая СК
     */
    public CoordinateSystem3d translate(Vector3d offset) {
        // рассчитываем новые границы
