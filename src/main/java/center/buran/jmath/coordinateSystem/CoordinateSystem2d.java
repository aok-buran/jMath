...
import static center.buran.jmath.vector.Vector2d.VECTOR_2D_OPACITY;
...
public class CoordinateSystem2d implements Serializable {
     ...
     */
    public Vector2d getRelativePos(Vector2d pos) {
        return Vector2d.subtract(pos, min);
    }
     ...
     * @return - новая СК
     */
    public CoordinateSystem2d scale(double s, Vector2d center) {
        ...
        Vector2d newSize = Vector2d.mul(getSize(), s);
        ...
        return new CoordinateSystem2d(newXMin, newXMax, newYMin, newYMax);
    }
     ...
     * @return - новая СК
     */
    public CoordinateSystem2d translate(Vector2d offset) {
        // рассчитываем новые границы
